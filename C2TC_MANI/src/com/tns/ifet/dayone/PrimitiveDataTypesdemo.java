...
public class PrimitiveDataTypesdemo {
	public static void main(String[] args) { 
		//byte takes 1 byte   byte byteMax = 127; 
		byte byteMin = -128;   
		System.out.println("Min range of byte is" +  byteMin+"Max range of byte is""+byteMax);                                                                                                                                                         "+byteMax);   
		//short - 2 bytes  
		...
		float f=3234.141243278345f;   double d=3456.14124512345678902345678914f;  
		System.out.println("float value is "+f+" double value is "+d);    
	}
		  //boolean    boolean flag=false;   System.out.println("boolean value is "+
}
